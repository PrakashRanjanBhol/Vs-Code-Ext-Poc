...
import { promptToTextDavinci003 } from './code-assistant-api.service';
import { window, ProgressLocation } from 'vscode';

export function registerCommand(apiKey: string) {

    /*Refactor */
    vscode.commands.registerCommand("vscode-code-assistant.refactor", () => {
        refactorCode(apiKey)
    });

    /*Add Comment */
    vscode.commands.registerCommand("vscode-code-assistant.addComments", () => {
        addComment(apiKey);
    });

    /*Add Documentaion */
    vscode.commands.registerCommand("vscode-code-assistant.addDocumentaion", () => {
        addDocument(apiKey);
    });
}
/**
 * Refactor code via Code Assistant
 * @param apiKey :string
 * @returns 
 */
